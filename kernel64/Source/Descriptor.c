...
void kInitializeIDTTables( void )
{
	...
	kSetIDTEntry(&(pstEntry[9]), kISRCoprocessorSegmentOverrun
			, 0x08, IDT_FLAGS_IST1, IDT_FLAGS_KERNEL, IDT_TYPE_INTERRUPT);
...
{
	kPrintString( 14, 8, 0x04,  "======================================================= " );
    kPrintString( 14, 9, 0x04,  "|          Dummy Interrupt Handler Execute~!!!        |" );
    kPrintString( 14, 10, 0x04, "|           Interrupt or Exception Occur~!!!!         |" );
    kPrintString( 14, 11, 0x04, "======================================================= " );
